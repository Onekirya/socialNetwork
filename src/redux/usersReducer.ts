...
const _followUnfollowFlow = async (dispatch: DispatchType, userId: number, apiMethod: (useerId: number) => Promise<ResponseType>, actionCreator: (userId: number) => ActionsTypes) => {
...
export type inicialState = typeof inicialState;
